...
* **The (Kanagawa Treaty)[https://en.wikipedia.org/wiki/Convention_of_Kanagawa] and the (Harris Treaty)[https://en.wikipedia.org/wiki/Treaty_of_Amity_and_Commerce_(United_States%E2%80%93Japan)] (together with appendices) can be found in full-text veersion in Wikisource: make sure to read these originals and point out the relevant articles. 
